...
def main():
    ...
    arm2 = Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    arm_1 = Node(arm, glm.translate(glm.vec3(.5,0,0)), glm.translate((.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    arm2_1 = Node(arm2, glm.translate(glm.vec3(-.5,0,0)), glm.translate((-.25,-0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        arm_1.set_joint_transform(glm.rotate(t, (0,0,1)))
        arm2_1.set_joint_transform(glm.rotate(t, (0,0,-1)))
        ...
        draw_node(vao_box, arm_1, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, arm2_1, P*V, MVP_loc_box, color_loc_box)
